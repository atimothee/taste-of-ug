...
public class TasteOfUgProvider extends ContentProvider {
    private static final String TAG = TasteOfUgProvider.class.getSimpleName();
    ...
    protected TasteOfUgSQLiteOpenHelper mTasteOfUgSQLiteOpenHelper;
    ...
    public boolean onCreate() {
        ...
        mTasteOfUgSQLiteOpenHelper = TasteOfUgSQLiteOpenHelper.getInstance(getContext());
        return true;
    }
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        long rowId = mTasteOfUgSQLiteOpenHelper.getWritableDatabase().insertOrThrow(table, null, values);
    ...
    public int bulkInsert(Uri uri, ContentValues[] values) {
        ...
        String table = uri.getLastPathSegment();
        SQLiteDatabase db = mTasteOfUgSQLiteOpenHelper.getWritableDatabase();
        int res = 0;
        db.beginTransaction();
        try {
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        int res = mTasteOfUgSQLiteOpenHelper.getWritableDatabase().update(queryParams.table, values, queryParams.selection, selectionArgs);
        String notify;
        if (res != 0 && ((notify = uri.getQueryParameter(QUERY_NOTIFY)) == null || "true".equals(notify))) {
            getContext().getContentResolver().notifyChange(uri, null);
        }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        QueryParams queryParams = getQueryParams(uri, selection, null);
        int res = mTasteOfUgSQLiteOpenHelper.getWritableDatabase().delete(queryParams.table, queryParams.selection, selectionArgs);
        String notify;
        if (res != 0 && ((notify = uri.getQueryParameter(QUERY_NOTIFY)) == null || "true".equals(notify))) {
            getContext().getContentResolver().notifyChange(uri, null);
        }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        Cursor res = mTasteOfUgSQLiteOpenHelper.getReadableDatabase().query(queryParams.tablesWithJoins, projection, queryParams.selection, selectionArgs, groupBy,
        ...
        switch (matchedId) {
            ...
            case URI_TYPE_RECIPE_ID:
                ...
                if (CategoryColumns.hasColumns(projection)) {
                    res.tablesWithJoins += " LEFT OUTER JOIN " + CategoryColumns.TABLE_NAME + " ON " + RecipeColumns.TABLE_NAME + "." + RecipeColumns.CATEGORYID + "=" + CategoryColumns.TABLE_NAME + "." + CategoryColumns._ID;
                }
